...
void display(void)
{
  ...
  char s[80];
  sprintf(s, "FPS: %5d  TIME %6.3lf SIMTIME %6.3lf%c", fps, GlobalResourceManager::use()->getActualTime(),
...
static void setargv(int *argcPtr, char ***argvPtr)
{
  ...
  argSpace = (char *)ckalloc((unsigned)(size * sizeof(char *) + strlen(cmdLine) + 1));
  argv = (char **)argSpace;
